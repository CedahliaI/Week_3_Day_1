...
# You can get a substring by specifiying the start and end index of the substring.
# The start index is inclusive and the end inex is exclusive
...
#when it says -1 it the substring is not found (it doesnt exist) and hancock does not exist in the string

# print ("hello") control / to trun code into comment
